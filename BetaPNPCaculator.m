% Các thông số đã cho
Vcc = 12.09;              % Nguồn Vcc (nối emitter) (V)
Vce_measured = 6.41    % Điện áp VCE thực tế cần đạt (V)
Vbe = 0.613;             % Giả sử V_BE (V)
Rb = 500e3;            % Rb = 500k ohm
Rc = 980;              % Rc = 1k ohm
Re = 983;              % Re = 1k ohm

% Hàm phi tuyến cần giải: f(B) = Vce_thực_tế - Vce_tính_từ_B = 0
